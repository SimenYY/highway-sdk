...
class TestXiankeMsg:
    def test_make_upload_file(self):
        ...
        actual = XianKeMsg.make_upload_file(content, file_path="list\\000.xkl")
    ...
    def test_make_download_file(self):
        actual = XianKeMsg.make_download_file(file_path="list\\000.xkl")
    ...
    def test_play_playlist(self):
        actual = XianKeMsg.make_play_playlist(file_name="000.xkl")
    ...
    def test_make_get_item(self):
        actual = XianKeMsg.make_get_item()
    ...
    def test_get_play(self):
        actual = XianKeMsg.make_get_play()
    ...
    def test_get_now_brightness(self):
        actual = XianKeMsg.make_get_now_brightness()
