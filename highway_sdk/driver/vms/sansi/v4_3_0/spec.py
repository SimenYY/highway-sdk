...
class SanSiWhat:
    # 获取当前内容
    GET_NOW_PLAY_CONTENT = b"97"

    # 获取当前播放列表
    GET_NOW_PLAY_ALL_CONTENT = b"" # ? 协议没看到
    ...
    # 设置当前显示亮度
    SET_NOW_BRIGHTNESS = b"05"

    # 取当前显示亮度和调节方式
    GET_NOW_BRIGHTNESS = b"06"
...
class SanSiPacketReq:
    ...
    def pack(cls, what: bytes, data: bytes, **kwargs) -> bytes:
        ...
        crc_16 = SansiCrc(to_check).crc()
        escaped_data_crc = SanSiEscape(data + crc_16).byte_to_short()
