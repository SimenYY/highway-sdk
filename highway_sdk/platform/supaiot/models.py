...
class DeviceListRequest(_baseSupaiotRequest):
    ...
    device_ids: Optional[List[str]] = Field(None, alias="ID", description="设备实例ID")
    ...
    labels: Optional[List[dict]] = Field(None, alias="label", description="标签")
...
class DeviceRealtimeDataListRequest(_baseSupaiotRequest):
    id_: List[str] = Field(..., alias="ID", description="设备ID列表")